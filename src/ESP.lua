...
local ConfigLibrary = loadstring(game.HttpGet(game, "https://raw.githubusercontent.com/ngnumeric3-png/JohnAim/refs/heads/main/configlib/Main.lua"))()
...
if identifyexecutor() == "Solara" then -- Quads are broken on Solara.
	local DrawQuad = loadstring(game.HttpGet(game, "https://raw.githubusercontent.com/ngnumeric3-png/JohnAim/refs/heads/main/customquad/Main.lua"))() -- Custom Quad Drawing Object
